...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200/70">
...
const FooterLink = ({ to, label }: { to: string; label: string }) => {
  return (
    <li>
      <Link 
        to={to} 
        className="text-gray-600 hover:text-gray-900 transition-all-300"
      >
        {label}
      </Link>
    </li>
...
const SocialLink = ({ href, label }: { href: string; label: string }) => {
  return (
    <a 
      ...
      className="text-gray-500 hover:text-gray-900 transition-all-300"
      aria-label={label}
    >
